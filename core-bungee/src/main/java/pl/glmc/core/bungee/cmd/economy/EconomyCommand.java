...
public class EconomyCommand extends Command implements TabExecutor {
    ...
    public EconomyCommand(final GlmcCoreBungee plugin) {
    ...
    public Iterable<String> onTabComplete(CommandSender sender, String[] args) {
        ...
        if (args.length == 0) {
            ...
            try {
                economyProvider = (ApiEconomyProvider) this.plugin.getApiProvider().getEconomyFactory().getEconomy(args[1]);
    ...
    public void execute(CommandSender sender, String[] args) {
        if (args.length == 0) {
            ...
            try {
                economy = (ApiEconomyProvider) this.plugin.getApiProvider().getEconomyFactory().getEconomy(args[1]);
            } catch (NullPointerException | ClassCastException e) {
    ...
    private void listEconomies(CommandSender sender) {
        ...
        for (EconomyConfig registeredConfig : this.plugin.getApiProvider().getEconomyFactory().getRegisteredConfigs()) {
